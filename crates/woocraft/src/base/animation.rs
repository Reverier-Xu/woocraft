...
//!
//! Provides ready-to-use animations (e.g., spinner rotation) utilizing theme duration settings.
...
///
/// Produces a repeating 360-degree rotation animation suitable for loading indicators.
