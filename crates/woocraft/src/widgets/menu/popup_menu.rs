...
use crate::widgets::menu::menu_item::MenuItemElement;
use crate::{
    ActiveTheme, ElementExt, Icon, IconName, Kbd, ScrollableElement, Size,
    StyleSized as _, h_flex, v_flex,
};
use gpui::{
...
impl PopupMenu {
    ...
    fn render_item(
        ...
        let item_height = self.size.component_height();
        let radius = self.size.component_radius().min(options.radius);
