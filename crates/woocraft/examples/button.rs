...
use woocraft::{
    ActiveTheme, Button, ButtonVariants as _, Disableable, IconName, Selectable, Size,
    Sizable as _, StyledExt, h_flex, init, v_flex,
    Theme, ThemeMode,
};
        ...
        v_flex()
            ...
            .child(
                h_flex()
                    ...
                    .child(Button::new("btn-disabled").label("Disabled").primary().disabled(true)),
            )
            ...
            .child(
                h_flex()
                    ...
                    .child(Button::new("btn-md").label("Medium").with_size(Size::Medium))
