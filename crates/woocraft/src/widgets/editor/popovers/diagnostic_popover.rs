...
use super::{Popover, render_markdown};
use crate::widgets::editor::{InputState, highlighter::DiagnosticEntry};
...
impl DiagnosticPopover {
  pub fn new(
    diagnostic: &DiagnosticEntry, state: Entity<InputState>, cx: &mut App,
  ) -> Entity<Self> {
