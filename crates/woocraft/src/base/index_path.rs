...
impl IndexPath {
  /// Create a new index path with the specified row.
  ///
  /// The `section` and `column` are set to 0 by default.
  ...
  /// Check whether two index paths are on the same row in the same section.
