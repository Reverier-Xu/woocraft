...
use gpui::{
    Context, Corner, DismissEvent, ElementId, Entity, Focusable, IntoElement,
...
pub trait DropdownMenu: Styled + Selectable + DropdownMenuTriggerId + IntoElement + 'static {
    ...
    fn dropdown_menu_with_anchor(
        ...
        DropdownMenuPopover::new(id, anchor, self, f).trigger_style(style)
    }
}
